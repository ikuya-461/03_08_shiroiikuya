...
<body>
    ...
    <script>
        ...
        var db = firebase.firestore().collection('anime');
        var id = localStorage.getItem('user.uid');
        console.log(id);
